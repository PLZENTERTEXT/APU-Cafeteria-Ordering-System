...
public class customerMenu extends javax.swing.JFrame {
    ...
    public customerMenu() {
        ...
        // Load the menu as soon as the window loads from "managerMenu" class
        loadMenu();
    ...
    private void initComponents() {
        ...
        userIDLabel.setBackground(new java.awt.Color(18, 18, 18));
        userIDLabel.setFont(new java.awt.Font("SF Pro Text", 1, 18)); // NOI18N
        userIDLabel.setForeground(new java.awt.Color(0, 102, 155));
        ...
        userPanel.add(userIDLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 50, 120, 50));
...
//        HomePage frame = new HomePage(userID.getText());
...
//        this.dispose();
    ...
    private void deleteFCButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteFCButtonActionPerformed
        ...
        } else if (orderItemTable.getSelectedRowCount() == 0){
    ...
    private void proceedTCButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_proceedTCButtonActionPerformed
        // Add string data to receipt.txt
//        FileHandling fh = new FileHandling();
//        File file = new File(receiptFile);
//        
//        try {
//            String fileData = foodID + "|" + food + "|" + price + "|" + quantity + "|" + total;
